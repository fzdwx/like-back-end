package cn.like.common.config;

import cn.hutool.core.date.DatePattern;
import cn.like.base.support.id.IdGenerator;
import cn.like.common.converter.*;
...
public abstract class BaseConfig {
	...
	public Jackson2ObjectMapperBuilderCustomizer jackson2ObjectMapperBuilderCustomizer() {
		return builder -> builder
		  ...
		  .serializerByType(
			LocalDate.class, new LocalDateSerializer(DateTimeFormatter.ofPattern(DatePattern.NORM_DATE_PATTERN)))
		  .serializerByType(
			LocalTime.class, new LocalTimeSerializer(DateTimeFormatter.ofPattern(DatePattern.NORM_TIME_PATTERN)))
		  .deserializerByType(
			LocalDateTime.class, new LocalDateTimeDeserializer(
			  DateTimeFormatter.ofPattern(DatePattern.NORM_DATETIME_PATTERN)))
		  .deserializerByType(
			LocalDate.class, new LocalDateDeserializer(DateTimeFormatter.ofPattern(DatePattern.NORM_DATE_PATTERN)))
		  .deserializerByType(
			LocalTime.class, new LocalTimeDeserializer(DateTimeFormatter.ofPattern(DatePattern.NORM_TIME_PATTERN)));
	}
	...
	@Bean
	public IdGenerator idGenerator(@Value("$id.work-id") final long workId,
								   @Value("$id.data-center-id") final long dataCenterId) {
		return new IdGenerator(workId, dataCenterId);
	}
}
